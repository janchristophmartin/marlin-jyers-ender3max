...
#define STRING_CONFIG_H_AUTHOR "JCM, J. Myers & Chad" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender-3 Max V2 x JCM"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 50, -11, -2.87 }
...
#define X_BED_SIZE 300  // Usable part of 310 mm glass dimension -> 5 mm border
#define Y_BED_SIZE 300  // Usable part of 320 mm glass dimension -> 10 mm border

// Travel limits (mm) after homing, corresponding to endstop positions.
#define X_MIN_POS 5    // Nozzle 0 mm over glass plate when at end switch -> 5 mm - 0 mm = 5 mm
#define Y_MIN_POS 1    // Nozzle 9 mm over glass plate when at end switch -> 10 mm - 9 mm = 1 mm
#define Z_MIN_POS 0
#define X_MAX_POS X_MIN_POS + X_BED_SIZE + 15  // Extended max to allow the probe to reach more of the bed. Some safe distance kept to actual max 
#define Y_MAX_POS Y_MIN_POS + Y_BED_SIZE       // NOT extended because of clips
